            ...
            <div class="col-md-9">
            	...
            	<div class="actions clearfix">
                	...
                	<div class="togglebutton <?php echo $buttonClass; ?> pull-right">
                       <a href="<?php echo osc_user_list_items_url(); ?>?ShowAs=list" class="list-button" data-class-toggle="listing-grid" data-destination="#listing-card-list"><i class="fa fa-th"></i> <?php _e('List','flatter'); ?></a>
                       <a href="<?php echo osc_user_list_items_url(); ?>?ShowAs=gallery" class="grid-button" data-class-toggle="listing-grid" data-destination="#listing-card-list"><i class="fa fa-th-list"></i> <?php _e('Grid','flatter'); ?></a>
                  	</div><!-- Togglebutton -->
                </div>
                <?php } ?>
