                ...
                <div id="content">
					...
					while(osc_has_alerts()) { ?>
						<div class="alert-item" >
							<h5><?php _e('Alert', 'flatter'); ?> <?php echo $i; ?><a class="delete" onclick="javascript:return confirm('<?php echo osc_esc_js(__('This action can\'t be undone. Are you sure you want to continue?', 'flatterw')); ?>');" href="<?php echo osc_user_unsubscribe_alert_url(); ?>"><?php _e('Delete this alert', 'flatter'); ?></a></h5>
