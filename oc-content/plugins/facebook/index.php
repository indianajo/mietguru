...
*/
    ...
    function fbc_button() {
        if( !osc_is_web_user_logged_in() ) {
            echo '<a class="btn btn-primary fb" href="' . OSCFacebook::newInstance()->loginUrl() . '"><i class="fa fa-facebook-square"></i> 	' . __( 'Login with Facebook', 'facebook' ) . '</a>';
        }
    }
	function fbc_button2() {
        if( !osc_is_web_user_logged_in() ) {
            echo '<a class="btn btn-primary fb" href="' . OSCFacebook::newInstance()->loginUrl() . '"><i class="fa fa-facebook-square"></i> 	' . __( 'Register with Facebook', 'clean' ) . '</a>';
        }
    }
